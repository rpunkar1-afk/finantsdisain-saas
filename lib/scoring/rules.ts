...
export const VKE_SCORING_RULES: ScoringRule[] = [
  ...
  },
  {
    ...
    bands: [
      ...
      { key: "cv_low_trend_flat", points: 10, label: "CV < 0.15, stabiilne/langev trend, VÕI CV 0.15-0.30 positiivne" },
      { key: "cv_mid_trend_flat", points: 5, label: "CV 0.15-0.30 stabiilne/langev, VÕI CV > 0.30 positiivne" },
